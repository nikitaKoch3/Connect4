...
struct ContentView: View {
    ...
    @State private var winner: winAlert? = nil
    ...
    var body: some View {
                ...
                ForEach(0..<36) { i in
                    Circle()
                        ...
                        .onTapGesture {
                            ...
                            if checkWinComination(player: .red) && winner == nil {
                                winner = alertCase.redWins
                            }
                            if checkWinComination(player: .yellow) {
                                winner = alertCase.yellowWins
                            }
                            lastSlot = nil
                            turn.toggle()
                        }
        ...
        .alert(item: $winner) { alertItem in
